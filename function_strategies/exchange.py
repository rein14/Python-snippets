...
class ExchangeConnection(Exception):
    """Custom error that is raised whenn an exchange is not conneted"""
...
class Exchange:
    ...
    def check_connection(self) -> None:
        ...
        if not self.connected:
            raise ExchangeConnection()
    
    def get_market_data(self, symbol: str) -> list[int]:
        """return fake market price data for given market symbol"""
